...
public class EmailPasswordAuth : MonoBehaviour
{
    ...
    public void SignUp()
    {
        ...
        string firstName = UIManager.firstName.text;

        string lastName = UIManager.lastName.text;

        string phone = UIManager.phone.text;

        DataManager.data.profileInfo.firstName = firstName;

        DataManager.data.profileInfo.lastName = lastName;

        DataManager.data.profileInfo.phone = phone;
